...
public class YoutubePlayerOptions: Encodable {
    ...
    public class Parameters: Codable {
         ...
         */
        var autoplay: YoutubeParameterBool?
        /**
         ...
         */
        var ccLoadPolicy: YoutubeParameterBool?
        /**
         ...
         */
        var controls: YoutubeParameterBool?
        /**
         ...
         */
        var disableKeyboard: YoutubeParameterBool?
        /**
         ...
         */
        var fullScreen: YoutubeParameterBool?
        /**
         ...
         */
        var listType: YoutubePlayerListType?
        /**
         ...
         */
        var modestBranding: YoutubeParameterBool?
        /**
         ...
         */
        var playsinline: YoutubeParameterBool?
        
             init(autoplay: YoutubeParameterBool? = nil,
